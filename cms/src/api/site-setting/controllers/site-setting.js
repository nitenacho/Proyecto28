...
const FIELD_MAP = {
  ...
  gameStairWidth: 'gameStairWidth',
  gameStairTriggerRadius: 'gameStairTriggerRadius',
  gameProjectileMax: 'gameProjectileMax',
  gameProjectileBurst: 'gameProjectileBurst',
  gameProjectileSpeed: 'gameProjectileSpeed',
  gameProjectileLifetime: 'gameProjectileLifetime',
  gameProjectileCooldown: 'gameProjectileCooldown',
...
const RULES = {
  ...
  gameStairWidth: { type: 'number', min: 0.8, max: 2.4 },
  gameStairTriggerRadius: { type: 'number', min: 0.45, max: 1.8 },
  gameProjectileMax: { type: 'int', min: 40, max: 720 },
  gameProjectileBurst: { type: 'int', min: 1, max: 8 },
  gameProjectileSpeed: { type: 'number', min: 3, max: 18 },
  gameProjectileLifetime: { type: 'number', min: 0.4, max: 2.4 },
  gameProjectileCooldown: { type: 'number', min: 0.02, max: 0.25 },
